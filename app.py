...
# Path to download the trained model from Google Drive
MODEL_DRIVE_LINK = "https://drive.google.com/uc?id=1tSihoCKtMsxpNnbhRVl8x8rCJeU0gA0A"
...
if not os.path.exists(MODEL_PATH):
    try:
        print("Attempting to download the model from Google Drive...")
        ...
        raise IOError("Model download failed. Please check the Google Drive link or permissions.")
...
try:
    ...
    raise IOError("Model loading failed. Ensure the downloaded model file is valid and compatible.")
